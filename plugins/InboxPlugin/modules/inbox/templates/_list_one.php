            ...
            <div class="stream-item  focused-stream-item">
                <div class="message-thread-preview stream-item-content">
                    ...
                    <div class="message-inner">
                        <?php echo image_tag($first_message->getUser()->getImage(), 'width=32 class=thumb'); ?>
        ...
        <div class="stream-items">
            <div class="stream-item  focused-stream-item">
                <div class="message-thread-preview stream-item-content">
                    <div class="more">»</div>
                    <div class="message-inner">
                        <?php echo image_tag($first_message->getUserDest()->getImage(), 'width=32 class=thumb'); ?>
                        <span class="user-name"><strong><?php echo $first_message->getUserDest()->getUsername() ?></strong> <b class="full-name"><?php echo $first_message->getUserDest()->getName() ?></b></span>
                        <div class="message-content">
                            <span class="created-at"><span class="_timestamp"><?php echo format_date($first_message->getCreatedAt(), "f") ?></span></span>
                            <div class="message-count">1</div>
                        </div>
