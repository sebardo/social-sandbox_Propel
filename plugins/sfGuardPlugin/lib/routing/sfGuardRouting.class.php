...
class sfGuardRouting {
    ...
    static public function addRouteForForgotPassword(sfEvent $event) {
        ...
        $r->prependRoute('sf_guard_forgot_password_change', new sfPropelRoute('/guard/forgot_password/:unique_key', array(
    ...
    /**
     * Adds an sfDPropelRouteCollection collection to manage users.
     *
     * @param sfEvent $event
     * @static
     */
    ...
    /**
     * Adds an sfPropelRouteCollection collection to manage groups.
     *
     * @param sfEvent $event
     * @static
     */
