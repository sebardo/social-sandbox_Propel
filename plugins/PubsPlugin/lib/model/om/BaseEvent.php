...
abstract class BaseEvent extends BaseObject  implements Persistent {
	...
	public function setSettingId($v)
	{
		...
		if ($this->setting_id !== $v) {
			$this->setting_id = $v;
			$this->modifiedColumns[] = EventPeer::SETTING_ID;
		}
	...
	public function setHour($v)
	{
		...
		if ( $this->hour !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EventPeer::HOUR;
			}
		} // if either are not null
	...
	public function setEndHour($v)
	{
		...
		if ( $this->end_hour !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EventPeer::END_HOUR;
			}
		} // if either are not null
	...
	public function setLatitude($v)
	{
		...
		if ($this->latitude !== $v) {
			$this->latitude = $v;
			$this->modifiedColumns[] = EventPeer::LATITUDE;
		}
	...
	public function setLongitude($v)
	{
		...
		if ($this->longitude !== $v) {
			$this->longitude = $v;
			$this->modifiedColumns[] = EventPeer::LONGITUDE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->hour = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->end_date = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->end_hour = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setHour($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setEndDate($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setEndHour($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventPeer::SETTING_ID)) $criteria->add(EventPeer::SETTING_ID, $this->setting_id);
		...
		if ($this->isColumnModified(EventPeer::HOUR)) $criteria->add(EventPeer::HOUR, $this->hour);
		if ($this->isColumnModified(EventPeer::END_DATE)) $criteria->add(EventPeer::END_DATE, $this->end_date);
		if ($this->isColumnModified(EventPeer::END_HOUR)) $criteria->add(EventPeer::END_HOUR, $this->end_hour);
		...
		if ($this->isColumnModified(EventPeer::LATITUDE)) $criteria->add(EventPeer::LATITUDE, $this->latitude);
		if ($this->isColumnModified(EventPeer::LONGITUDE)) $criteria->add(EventPeer::LONGITUDE, $this->longitude);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EventPeer::SETTING_ID, $this->setting_id);
		$criteria->add(EventPeer::USER_ID, $this->user_id);
