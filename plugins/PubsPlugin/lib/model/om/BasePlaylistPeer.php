...
abstract class BasePlaylistPeer {
	...
	const CLASS_DEFAULT = 'plugins.PubsPlugin.lib.model.Playlist';
	...
	const IS_ACTIVE = 'Playlist.IS_ACTIVE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'UserId', 'Description', 'Image', 'IsActive', 'Plays', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'userId', 'description', 'image', 'isActive', 'plays', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::USER_ID, self::DESCRIPTION, self::IMAGE, self::IS_ACTIVE, self::PLAYS, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'user_id', 'description', 'image', 'is_active', 'plays', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'UserId' => 2, 'Description' => 3, 'Image' => 4, 'IsActive' => 5, 'Plays' => 6, 'CreatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'userId' => 2, 'description' => 3, 'image' => 4, 'isActive' => 5, 'plays' => 6, 'createdAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::USER_ID => 2, self::DESCRIPTION => 3, self::IMAGE => 4, self::IS_ACTIVE => 5, self::PLAYS => 6, self::CREATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'user_id' => 2, 'description' => 3, 'image' => 4, 'is_active' => 5, 'plays' => 6, 'created_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PlaylistPeer::IMAGE);
		$criteria->addSelectColumn(PlaylistPeer::IS_ACTIVE);
		$criteria->addSelectColumn(PlaylistPeer::PLAYS);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PlaylistPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Playlist objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		PlaylistPeer::addSelectColumns($criteria);
		$startcol = (PlaylistPeer::NUM_COLUMNS - PlaylistPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Playlist) to $obj2 (sfGuardUser)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		PlaylistPeer::addSelectColumns($criteria);
		$startcol2 = (PlaylistPeer::NUM_COLUMNS - PlaylistPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Playlist) to the collection in $obj2 (sfGuardUser)
				$obj2->addPlaylist($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePlaylistPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePlaylistPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePlaylistPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePlaylistPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePlaylistPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePlaylistPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePlaylistPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePlaylistPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += PlaylistPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(AudioHasPlaylistPeer::PL_ID, $obj->getId());
