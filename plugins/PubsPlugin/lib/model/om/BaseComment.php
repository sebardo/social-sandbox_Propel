...
abstract class BaseComment extends BaseObject  implements Persistent {
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = CommentPeer::DESCRIPTION;
		}
	...
	public function setRecordModel($v)
	{
		...
		if ($this->record_model !== $v) {
			$this->record_model = $v;
			$this->modifiedColumns[] = CommentPeer::RECORD_MODEL;
		}
	...
	public function setRecordId($v)
	{
		...
		if ($this->record_id !== $v) {
			$this->record_id = $v;
			$this->modifiedColumns[] = CommentPeer::RECORD_ID;
		}
	...
	public function setDestUserId($v)
	{
		...
		if ($this->dest_user_id !== $v) {
			$this->dest_user_id = $v;
			$this->modifiedColumns[] = CommentPeer::DEST_USER_ID;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = CommentPeer::IS_ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->record_model = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->record_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->user_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->dest_user_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getRecordModel(),
			$keys[3] => $this->getRecordId(),
			$keys[4] => $this->getUserId(),
			$keys[5] => $this->getDestUserId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setRecordModel($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setRecordId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setUserId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setDestUserId($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CommentPeer::DESCRIPTION)) $criteria->add(CommentPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(CommentPeer::RECORD_MODEL)) $criteria->add(CommentPeer::RECORD_MODEL, $this->record_model);
		if ($this->isColumnModified(CommentPeer::RECORD_ID)) $criteria->add(CommentPeer::RECORD_ID, $this->record_id);
		if ($this->isColumnModified(CommentPeer::USER_ID)) $criteria->add(CommentPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(CommentPeer::DEST_USER_ID)) $criteria->add(CommentPeer::DEST_USER_ID, $this->dest_user_id);
		if ($this->isColumnModified(CommentPeer::IS_ACTIVE)) $criteria->add(CommentPeer::IS_ACTIVE, $this->is_active);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CommentPeer::USER_ID, $this->user_id);
		$criteria->add(CommentPeer::DEST_USER_ID, $this->dest_user_id);
	...
	public function setsfGuardUserRelatedByDestUserId(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addCommentRelatedByDestUserId($this);
		}
	...
	public function getsfGuardUserRelatedByDestUserId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDestUserId === null && ($this->dest_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDestUserId->addCommentsRelatedByDestUserId($this);
			 */
		}
