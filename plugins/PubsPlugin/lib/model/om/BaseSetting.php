...
abstract class BaseSetting extends BaseObject  implements Persistent {
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = SettingPeer::IS_ACTIVE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SettingPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = SettingPeer::NUM_COLUMNS - SettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(SettingPeer::CREATED_AT))
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingPeer::IS_ACTIVE)) $criteria->add(SettingPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(SettingPeer::CREATED_AT)) $criteria->add(SettingPeer::CREATED_AT, $this->created_at);
	 ...
	 * Otherwise if this Setting has previously been saved, it will retrieve
	 * related SettingHasUsers from storage. If this Setting is new, it will return
		...
		if ($this->collSettingHasUsers === null) {
			if ($this->isNew()) {
			   $this->collSettingHasUsers = array();
				...
				$criteria->add(SettingHasUserPeer::SETTING_ID, $this->id);
	 ...
	 * Otherwise if this Setting is new, it will return
	 * an empty collection; or if this Setting has previously
	 * been saved, it will retrieve related SettingHasUsers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Setting.
	 */
	public function getSettingHasUsersJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(SettingPeer::DATABASE_NAME);
		}
		...
		if ($this->collSettingHasUsers === null) {
			if ($this->isNew()) {
				...
				$this->collSettingHasUsers = SettingHasUserPeer::doSelectJoinsfGuardUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Setting has previously been saved, it will retrieve
	 * related Events from storage. If this Setting is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collEvents === null) {
			if ($this->isNew()) {
			   $this->collEvents = array();
				...
				$criteria->add(EventPeer::SETTING_ID, $this->id);
