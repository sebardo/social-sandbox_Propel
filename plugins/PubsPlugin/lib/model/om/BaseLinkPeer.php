...
abstract class BaseLinkPeer {
	...
	const CLASS_DEFAULT = 'plugins.PubsPlugin.lib.model.Link';
	...
	const SITE_NAME = 'Link.SITE_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Url', 'Image', 'Title', 'SiteName', 'Description', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'url', 'image', 'title', 'siteName', 'description', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::URL, self::IMAGE, self::TITLE, self::SITE_NAME, self::DESCRIPTION, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'url', 'image', 'title', 'site_name', 'description', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Url' => 2, 'Image' => 3, 'Title' => 4, 'SiteName' => 5, 'Description' => 6, 'CreatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'url' => 2, 'image' => 3, 'title' => 4, 'siteName' => 5, 'description' => 6, 'createdAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::URL => 2, self::IMAGE => 3, self::TITLE => 4, self::SITE_NAME => 5, self::DESCRIPTION => 6, self::CREATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'url' => 2, 'image' => 3, 'title' => 4, 'site_name' => 5, 'description' => 6, 'created_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LinkPeer::USER_ID);
		$criteria->addSelectColumn(LinkPeer::URL);
		$criteria->addSelectColumn(LinkPeer::IMAGE);
		$criteria->addSelectColumn(LinkPeer::TITLE);
		$criteria->addSelectColumn(LinkPeer::SITE_NAME);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LinkPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Link objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Link) to $obj2 (sfGuardUser)
				$obj2->addLink($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Link) to the collection in $obj2 (sfGuardUser)
				$obj2->addLink($obj1);
