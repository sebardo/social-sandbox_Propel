...
abstract class BaseLink extends BaseObject  implements Persistent {
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = LinkPeer::USER_ID;
		}
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = LinkPeer::IMAGE;
		}
	...
	public function setSiteName($v)
	{
		...
		if ($this->site_name !== $v) {
			$this->site_name = $v;
			$this->modifiedColumns[] = LinkPeer::SITE_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->site_name = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setSiteName($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LinkPeer::USER_ID)) $criteria->add(LinkPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(LinkPeer::URL)) $criteria->add(LinkPeer::URL, $this->url);
		if ($this->isColumnModified(LinkPeer::IMAGE)) $criteria->add(LinkPeer::IMAGE, $this->image);
		if ($this->isColumnModified(LinkPeer::TITLE)) $criteria->add(LinkPeer::TITLE, $this->title);
		if ($this->isColumnModified(LinkPeer::SITE_NAME)) $criteria->add(LinkPeer::SITE_NAME, $this->site_name);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addLinks($this);
			 */
		}
