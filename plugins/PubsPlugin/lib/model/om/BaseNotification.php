...
abstract class BaseNotification extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the related_model field.
	 * @var        string
	 */
	...
	/**
	 * Get the [related_model] column value.
	 * 
	 * @return     string
	 */
	...
	public function setDestUserId($v)
	{
		...
		if ($this->dest_user_id !== $v) {
			$this->dest_user_id = $v;
			$this->modifiedColumns[] = NotificationPeer::DEST_USER_ID;
		}
	...
	public function setRecordModel($v)
	{
		...
		if ($this->record_model !== $v) {
			$this->record_model = $v;
			$this->modifiedColumns[] = NotificationPeer::RECORD_MODEL;
		}
	...
	public function setRecordId($v)
	{
		...
		if ($this->record_id !== $v) {
			$this->record_id = $v;
			$this->modifiedColumns[] = NotificationPeer::RECORD_ID;
		}
	...
	/**
	 * Set the value of [related_model] column.
	 * 
	 * @param      string $v new value
	 * @return     Notification The current object (for fluent API support)
	 */
	public function setRelatedModel($v)
	{
		...
		if ($this->related_model !== $v) {
			...
			$this->modifiedColumns[] = NotificationPeer::RELATED_MODEL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->related_model = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			...
			return $startcol + 8; // 8 = NotificationPeer::NUM_COLUMNS - NotificationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setRelatedModel($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotificationPeer::DEST_USER_ID)) $criteria->add(NotificationPeer::DEST_USER_ID, $this->dest_user_id);
		if ($this->isColumnModified(NotificationPeer::RECORD_MODEL)) $criteria->add(NotificationPeer::RECORD_MODEL, $this->record_model);
		if ($this->isColumnModified(NotificationPeer::RECORD_ID)) $criteria->add(NotificationPeer::RECORD_ID, $this->record_id);
		if ($this->isColumnModified(NotificationPeer::RELATED_MODEL)) $criteria->add(NotificationPeer::RELATED_MODEL, $this->related_model);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NotificationPeer::USER_ID, $this->user_id);
		$criteria->add(NotificationPeer::DEST_USER_ID, $this->dest_user_id);
	...
	public function getsfGuardUserRelatedByUserId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUserId === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUserRelatedByUserId->addNotificationsRelatedByUserId($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDestUserId(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addNotificationRelatedByDestUserId($this);
		}
	...
	public function getsfGuardUserRelatedByDestUserId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDestUserId === null && ($this->dest_user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDestUserId->addNotificationsRelatedByDestUserId($this);
			 */
		}
