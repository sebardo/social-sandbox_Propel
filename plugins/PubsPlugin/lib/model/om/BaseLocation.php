...
abstract class BaseLocation extends BaseObject  implements Persistent {
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = LocationPeer::DESCRIPTION;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $this->isNew()) {
			$this->is_active = $v;
			$this->modifiedColumns[] = LocationPeer::IS_ACTIVE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LocationPeer::DESCRIPTION)) $criteria->add(LocationPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(LocationPeer::IS_ACTIVE)) $criteria->add(LocationPeer::IS_ACTIVE, $this->is_active);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LocationPeer::USER_ID, $this->user_id);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addLocations($this);
			 */
		}
