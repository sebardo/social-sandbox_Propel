...
abstract class BaseText extends BaseObject  implements Persistent {
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = TextPeer::USER_ID;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = TextPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TextPeer::NUM_COLUMNS - TextPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TextPeer::USER_ID)) $criteria->add(TextPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(TextPeer::DESCRIPTION)) $criteria->add(TextPeer::DESCRIPTION, $this->description);
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addTexts($this);
			 */
		}
