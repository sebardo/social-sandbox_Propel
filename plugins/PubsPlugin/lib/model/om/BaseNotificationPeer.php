...
abstract class BaseNotificationPeer {
	...
	const CLASS_DEFAULT = 'plugins.PubsPlugin.lib.model.Notification';
	...
	const DEST_USER_ID = 'Notification.DEST_USER_ID';

	/** the column name for the RECORD_MODEL field */
	const RECORD_MODEL = 'Notification.RECORD_MODEL';

	/** the column name for the RECORD_ID field */
	const RECORD_ID = 'Notification.RECORD_ID';

	/** the column name for the RELATED_MODEL field */
	const RELATED_MODEL = 'Notification.RELATED_MODEL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'DestUserId', 'RecordModel', 'RecordId', 'RelatedModel', 'CreatedAt', 'IsActive', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'destUserId', 'recordModel', 'recordId', 'relatedModel', 'createdAt', 'isActive', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::DEST_USER_ID, self::RECORD_MODEL, self::RECORD_ID, self::RELATED_MODEL, self::CREATED_AT, self::IS_ACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'dest_user_id', 'record_model', 'record_id', 'related_model', 'created_at', 'is_active', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'DestUserId' => 2, 'RecordModel' => 3, 'RecordId' => 4, 'RelatedModel' => 5, 'CreatedAt' => 6, 'IsActive' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'destUserId' => 2, 'recordModel' => 3, 'recordId' => 4, 'relatedModel' => 5, 'createdAt' => 6, 'isActive' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::DEST_USER_ID => 2, self::RECORD_MODEL => 3, self::RECORD_ID => 4, self::RELATED_MODEL => 5, self::CREATED_AT => 6, self::IS_ACTIVE => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'dest_user_id' => 2, 'record_model' => 3, 'record_id' => 4, 'related_model' => 5, 'created_at' => 6, 'is_active' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NotificationPeer::DEST_USER_ID);
		$criteria->addSelectColumn(NotificationPeer::RECORD_MODEL);
		$criteria->addSelectColumn(NotificationPeer::RECORD_ID);
		$criteria->addSelectColumn(NotificationPeer::RELATED_MODEL);
	...
	public static function doCountJoinsfGuardUserRelatedByUserId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NotificationPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinsfGuardUserRelatedByDestUserId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(NotificationPeer::DEST_USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Notification objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUserRelatedByUserId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Notification) to $obj2 (sfGuardUser)
	...
	public static function doSelectJoinsfGuardUserRelatedByDestUserId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Notification) to $obj2 (sfGuardUser)
				$obj2->addNotificationRelatedByDestUserId($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Notification) to the collection in $obj2 (sfGuardUser)
				$obj2->addNotificationRelatedByUserId($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Notification) to the collection in $obj3 (sfGuardUser)
				$obj3->addNotificationRelatedByDestUserId($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Notification objects pre-filled with all related objects except sfGuardUserRelatedByUserId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Notification objects pre-filled with all related objects except sfGuardUserRelatedByDestUserId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseNotificationPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseNotificationPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(NotificationPeer::USER_ID);
			$selectCriteria->add(NotificationPeer::USER_ID, $criteria->remove(NotificationPeer::USER_ID), $comparison);

			$comparison = $criteria->getComparison(NotificationPeer::DEST_USER_ID);
			$selectCriteria->add(NotificationPeer::DEST_USER_ID, $criteria->remove(NotificationPeer::DEST_USER_ID), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(NotificationPeer::USER_ID, $value[1]));
				$criterion->addAnd($criteria->getNewCriterion(NotificationPeer::DEST_USER_ID, $value[2]));
	...
	public static function retrieveByPK($id, $user_id, $dest_user_id, PropelPDO $con = null) {
		...
		$criteria->add(NotificationPeer::USER_ID, $user_id);
		$criteria->add(NotificationPeer::DEST_USER_ID, $dest_user_id);
