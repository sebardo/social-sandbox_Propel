...
abstract class BaseLocationPeer {
	...
	const CLASS_DEFAULT = 'plugins.PubsPlugin.lib.model.Location';
	...
	const IS_ACTIVE = 'Location.IS_ACTIVE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Description', 'IsActive', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'description', 'isActive', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::DESCRIPTION, self::IS_ACTIVE, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'description', 'is_active', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Description' => 2, 'IsActive' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'description' => 2, 'isActive' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::DESCRIPTION => 2, self::IS_ACTIVE => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'description' => 2, 'is_active' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocationPeer::DESCRIPTION);
		$criteria->addSelectColumn(LocationPeer::IS_ACTIVE);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LocationPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Location objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Location) to $obj2 (sfGuardUser)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Location) to the collection in $obj2 (sfGuardUser)
				$obj2->addLocation($obj1);
    ...
    foreach (sfMixer::getCallables('BaseLocationPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseLocationPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(LocationPeer::USER_ID);
			$selectCriteria->add(LocationPeer::USER_ID, $criteria->remove(LocationPeer::USER_ID), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(LocationPeer::ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(LocationPeer::USER_ID, $value[1]));
				$criteria->addOr($criterion);
				// we can invalidate the cache for this single PK
				LocationPeer::removeInstanceFromPool($value);
			}
		}
	...
	public static function retrieveByPK($id, $user_id, PropelPDO $con = null) {
		...
		$criteria->add(LocationPeer::ID, $id);
		$criteria->add(LocationPeer::USER_ID, $user_id);
