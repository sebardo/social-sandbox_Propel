...
/**
 * This class defines the structure of the 'Pubs' table.
 *
 *
 ...
 */
class PubsTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.PubsPlugin.lib.model.map.PubsTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('Pubs');
		$this->setPhpName('Pubs');
		$this->setClassname('Pubs');
