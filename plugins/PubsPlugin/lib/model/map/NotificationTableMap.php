...
class NotificationTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.PubsPlugin.lib.model.map.NotificationTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('RELATED_MODEL', 'RelatedModel', 'VARCHAR', false, 255, null);
		$this->addColumn('CREATED_AT', 'CreatedAt', 'VARCHAR', false, 255, null);
