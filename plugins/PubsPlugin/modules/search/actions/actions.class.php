...
class searchActions extends sfActions {
    ...
    public function executeIndex(sfWebRequest $request) {
        ...
        if ($user->isAuthenticated()) {
            ...
            $this->users = sfGuardUserPeer::getAllUsers();
    ...
    public function executeList(sfWebRequest $request) {
        ...
        if ($user->isAuthenticated()) {
            $this->datos = $user->getGuardUser();
            $this->users = sfGuardUserPeer::getAllUsers($request->getParameter('sex'),$request->getParameter('minAge'),$request->getParameter('maxAge'),$request->getParameter('country'));
