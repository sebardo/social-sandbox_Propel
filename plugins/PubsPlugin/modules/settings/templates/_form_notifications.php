        ...
        <div class="clearfix">
            ...
            <div class="input">
                <ul class="options">
                    ...
                    <?php 
                    $i = new Criteria();
                    $i->add(SettingPeer::IS_ACTIVE, true);
                    $settings = sfGuardUserPeer::doSelect($i);
                   
//                    $settings = Doctrine::getTable('Setting')->findBy('is_active', true); 
                    ?>
                    <?php foreach ($settings as $setting): ?>


                        <li>
                            <?php $setting_user = SettingHasUserPeer::SettingUser($sf_user->getGuardUser()->getId(), $setting->getId()); ?>
