...
<div class="data-profile">
    <li>
        <a href="<?php echo sfConfig::get('app_base_url') ?>pubs" class="user-stats-count">
                <?php echo PubsPeer::getPubs($datos->getId())?>
            
            <span class="user-stats-stat"><?php echo __('Pubs', null, 'pubs') ?></span>
        </a>
    </li>
    ...
    <li><a href="#" class="user-stats-count">
            <?php echo count($datos->getFollower())?>
            <span class="user-stats-stat"><?php echo __('Followers', null, 'follow') ?></span></a></li>
    <?php if (in_array('favlike', sfConfig::get('sf_enabled_modules', array()))) { ?>
    <li><a href="<?php echo sfConfig::get('app_base_url') ?>favlike" class="user-stats-count">
            <?php echo FavlikePeer::getFavlikes($datos->getId())?>
            <span class="user-stats-stat"><?php echo __('Favlikes', null, 'pubs') ?></span></a></li>
    <?php } ?>
    <?php if (in_array('comment', sfConfig::get('sf_enabled_modules', array()))) { ?>
    <li><a href="#" class="user-stats-count">
        <?php echo CommentPeer::getComments($datos->getId())?>
            <span class="user-stats-stat"><?php echo __('Comments', null, 'pubs') ?></span></a></li>
    <?php } ?>
</div>
