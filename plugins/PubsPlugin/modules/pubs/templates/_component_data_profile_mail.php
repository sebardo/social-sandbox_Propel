...
<div class="data-profile" style="overflow: hidden; 
    ...
    <li style="float: left;
        ...
        margin-left: 0;
        overflow: hidden;
        padding: 0 12px;"><a href="#" style="text-decoration: none;color: #666666;font-size: 15px;font-weight: bold;"><?php echo PubsPeer::getPubs($datos->getId())?><span class="user-stats-stat" style="color: #444444;font-size: 11px !important;clear: both; display: block; padding: 3px 0;font-weight: lighter !important;"><?php echo __('Pubs', null, 'pubs') ?></span></a></li>
